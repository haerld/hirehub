...
export default function LoginForm() {
	return (
		<form className="flex flex-col gap-5">
			<Button formAction={"/api/auth/google"} variant="outline" className="flex w-full gap-2">
				<GoogleSVG />
				Login with Google
			</Button>
			<Button formAction={"/api/auth/microsoft"} variant="outline" className="flex w-full gap-2">
				<MicrosoftSVG />
